...
const handlePhoneNumberChange = (event) => {
  ...
  return (
    <div style={{ height: "290px", overflowY: "scroll", textAlign: "center" }}>
      <form><Box sx={{ display: "flex", flexWrap: "wrap" }}>
        <div>
        <h6 className='support2'>*ALUMNI SIGNUP FORM*</h6> 
  ...
  <TextField
    ...
    sx={{ m: 1, flex: 1, right: "-100px", width: '94%' }}
    variant="filled"
    size="small"
  ...
  {isHovering && !isIncomeValid && (
    <FormHelperText
      error
      sx={{ m: 1, width: '100%', marginTop: '10px', marginRight: '-120px',marginLeft:'115px' }}
    >
...
<div>
          ...
          <div className="hex"> <input type="file" id="myFile" name="filename" className="upload"/> </div>
        ...
        <div style={{ display: "flex" }}>
            ...
            <TextField
              ...
              label="Postal Code"
              id="filled-basic"
              sx={{ m: 1, flex: 1, right: "-100px", width:'230px' }}
              variant="filled"
              size="small"
              inputMode="numeric"
            />
...
<TextField
  ...
  sx={{ m: 1, width: '39.5%', marginLeft: '77px',  }}
  variant="filled"
  size="small"
  required
  inputMode="numeric"
...
<br/> <br/>
<div>
    <button className="subway2" type="submit">Submit</button>

  ...
  return (
    <div style={{ height: "290px", overflowY: "scroll", textAlign: "center" }}>
      <form><Box sx={{ display: "flex", flexWrap: "wrap" }}>
        <div>
        <h6 className='support2'>*FACULTY SIGNUP FORM*</h6> 
...
<TextField
  style={{ m: 1, flex: 1, marginRight: '-196px', width: '96%' }}
  ...
  SelectProps={{
    MenuProps: {
      PaperProps: {
        style: {
          maxHeight: "200px",marginLeft:'7px',
          width: "auto",
        },
      },
    },
...
<Autocomplete
  ...
  renderInput={(params) => (
    <TextField
      {...params}
      label="Country Code"
      sx={{ m: 1, width: '91%', marginLeft:'109px' }}
      variant="filled"
      size="small"
    />
  )}
...
<TextField
  ...
  sx={{ m: 1, width: '39.5%', marginLeft: '90px',  }}
  variant="filled"
  size="small"
  required
  inputMode="numeric"
...
<br/> <br/>
<div>
    <button className="subway" type="submit">Submit</button>

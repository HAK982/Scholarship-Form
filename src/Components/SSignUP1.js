...
export default function SSignUP1() {
...
// ///////PASSWORD CHWCKER
  ...
  return (
    <div style={{ height: "260px", overflowY: "scroll", textAlign: "center" }}>
      <form><Box sx={{ display: "flex", flexWrap: "wrap" }}>
        <div>
        <h6 className='support2'>*STUDENT SIGNUP FORM*</h6> 
...
<TextField
  ...
  sx={{ m: 1, width: '40%', marginLeft: '90px',  }}
  variant="filled"
  size="small"
  required
  inputMode="numeric"
